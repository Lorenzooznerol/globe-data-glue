...
// Numeric ISO 3166-1 → ISO3 alpha for the world-atlas topojson variant.
// Only used when the source file is TopoJSON without alpha props.
const NUMERIC_TO_ISO3: Record<string, string> = {
  ...
  "084": "BLZ", "090": "SLB", "092": "VGB", "096": "BRN", "100": "BGR", "104": "MMR",
  "108": "BDI", "112": "BLR", "116": "KHM", "120": "CMR", "124": "CAN", "132": "CPV",
  "136": "CYM", "140": "CAF", "144": "LKA", "148": "TCD", "152": "CHL", "156": "CHN",
  "158": "TWN", "162": "CXR", "166": "CCK", "170": "COL", "174": "COM", "175": "MYT",
  "178": "COG", "180": "COD", "184": "COK", "188": "CRI", "191": "HRV", "192": "CUB",
  "196": "CYP", "203": "CZE", "204": "BEN", "208": "DNK", "212": "DMA", "214": "DOM",
  "218": "ECU", "222": "SLV", "226": "GNQ", "231": "ETH", "232": "ERI", "233": "EST",
  "234": "FRO", "238": "FLK", "239": "SGS", "242": "FJI", "246": "FIN", "248": "ALA",
...
function normalize(data: unknown): CountryFeature[] {
  const obj = data as { type?: string; features?: unknown[]; objects?: Record<string, unknown> };
  let features: Array<{ id?: string | number; properties?: Record<string, unknown>; geometry: unknown }>;

  if (obj?.type === "Topology") {
    const topo = obj as unknown as Topology;
    const objKey = Object.keys(topo.objects)[0];
    const fc = topoFeature(topo, topo.objects[objKey] as GeometryCollection);
    features = (fc as { features: typeof features }).features;
  } else if (Array.isArray(obj?.features)) {
    features = obj.features as typeof features;
  } else {
    return [];
  }
  ...
  return features.map((f) => {
    ...
    const numericId = f.id != null ? String(f.id).padStart(3, "0") : undefined;
    const iso3 =
      (props.ADM0_A3 as string | undefined) ??
      (props.ISO_A3 as string | undefined) ??
      (numericId ? NUMERIC_TO_ISO3[numericId] : undefined) ??
      "";
    const name = (props.NAME as string | undefined) ?? (props.name as string | undefined) ?? "";
    return {
      type: "Feature",
      properties: { NAME: name, ISO_A3: iso3, ADM0_A3: iso3 },
      geometry: f.geometry,
    };
  });
}
